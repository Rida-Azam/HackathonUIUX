...
import { FaStar,  FaInstagram, FaTwitter, FaFacebookF, FaArrowRight } from "react-icons/fa";
...
function ProductDetailPage() {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-1">
    ...
    <div className="flex gap-2">
        ...
        {/* Product Information */}
        <div>
          <h1 className="text-2xl font-bold mb-2 text-[#0D134E]">Playwood Arm Chair</h1>
          ...
          <div className="flex items-center space-x-1">
            <span className="text-sm font-semibold text-textcontact">$32.00</span>
            <span className="text-sm line-through font-semibold text-pink1">$32.00</span>
          </div>
          ...
          <h1 className="text-textcontact font-semibold mb-2">Categories :</h1>
  ...
  <div className="w-full max-w-7xl bg-[#F9F8FE] px-12 lg:px-16">
    <div className="py-12 lg:py-16">
      ...
      <div className="mb-8">
        <h2 className="mb-6 text-textcontact font-bold font-josefin text-lg ">Varius tempor.</h2>
        <p className="text-[#A9ACC6] text-md mb-8">
          ...
          habitasse amet. Montes, mauris varius ac est bibendum.<br /> Scelerisque a, risus ac ante. Velit consectetur
          neque, elit, aliquet. Non varius proin sed urna, egestas consequat laoreet diam tincidunt. Magna eget
          faucibus<br /> cras justo, tortor sed donec tempus. Imperdiet consequat, quis diam arcu, nulla lobortis justo
          netus dis. Eu in fringilla vulputate nunc nec. Dui, massa viverr.
        </p>
      </div>

      {/* More Detail Section with more margin */}
      <h2 className=" mb-6 text-textcontact font-bold font-josefin text-lg ">More Detail</h2>
      {Array(5)
        .fill(null)
        .map((_, index) => (
...
<div className="bg-white px-6 lg:px-16 py-10 mt-8">
  <h2 className="text-3xl font-bold mb-8 text-[#101750] font-josefin text-start">Related Products</h2>
    ...
    {products.map((product) => (
      ...
      >
        ...
        <div className="flex justify-between items-center w-full px-4 mt-2">
          <h3 className="text-sm font-semibold font-josefin text-textcontact truncate">{product.name}</h3>
          <div className="flex gap-1">
            {Array(product.rating)
              .fill(0)
              .map((_, index) => (
                <span key={index} className="text-yellow1">★</span>
              ))}
        ...
        {/* Price on Next Line */}
        <p className="text-textcontact font-josefin font-bold mt-1 px-4 w-full text-left">{product.price}</p>
      </div>
    ))}
  </div>
</div>
