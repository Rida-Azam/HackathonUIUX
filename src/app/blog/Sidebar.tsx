    ...
    <div className="p-4">
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-y-3 gap-x-6 text-gray-700">
          ...
          <div className="font-lato font-bold">            <a href="#" className="hover:text-pink-500  ">
              Women (21)
            </a>
          </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <span className="px-2 py-1 text-pink-500 underline text-sm">Atsanil</span>
          <span className="px-2 py-1 text-textcolor underline text-sm">Insas</span>
          <div className="w-full flex gap-3">
            <span className="px-2 py-1 text-textcolor underline text-sm">Bibsaas</span>
            <span className="px-2 py-1 text-textcolor underline text-sm">Nulla</span>
          </div>
        </div>
      </div>
    </div>
